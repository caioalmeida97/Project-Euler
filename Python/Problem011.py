...
for i in range(len(grid)):
    for j in range(len(grid[i])):
        ...
        if j+3 < len(grid[i]):
            ...
            product = horizontal[0]*horizontal[1]*horizontal[2]*horizontal[3];
        ...
        if i+3 < len(grid):
            ...
            product = vertical[0]*vertical[1]*vertical[2]*vertical[3];
            if product > greatestProduct:
                greatestProduct = product;
                product = 1;
        ...
        if j+3 < len(grid[i]) and i+3 < len(grid):
            ...
            product = diagonal1[0]*diagonal1[1]*diagonal1[2]*diagonal1[3];
            if product > greatestProduct:
                greatestProduct = product;
                product = 1;
        ...
        if j+3 < len(grid[i]) and i - 3 > 0:
            ...
            product = diagonal2[0]*diagonal2[1]*diagonal2[2]*diagonal2[3];
            if product > greatestProduct:
                greatestProduct = product;
                product = 1;
